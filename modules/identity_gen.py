...
def show_identity_gen(lang="EN"):
    ...
    DICTIONARY = {
        ...
        "FR": {
            ...
            "tips": {"dcg": "Code pays ISO", "dac": "Prénoms", "dcs": "Nom de famille", "dbb": "Date de naissance", "daq": "Identifiant du permis", "dag": "Adresse", "dai": "Ville", "dak": "Code postal", "dbd": "Date d'émission", "dba": "Date d'expiration", "dbc": "Sexe (1:M, 2:F)", "dcf": "Numéro d'audit"}
        }
    }
