...
def show_identity_gen(lang="EN"):
    ...
    DICTIONARY = {
        ...
        "FR": {
            ...
            "tips": {"dcg": "Code Pays ISO", "dac": "Prénoms", "dcs": "Nom de famille", "dbb": "Date de naissance", "daq": "Identifiant de permis", "dag": "Adresse résidentielle", "dai": "Ville / Localité", "dak": "Code Postal", "dbd": "Date d'émission", "dba": "Date d'expiration", "dbc": "Genre (1=M, 2=F)", "dcf": "Numéro d'audit"}
        }
    }
