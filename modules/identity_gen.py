...
def show_identity_gen(lang="EN"):
    ...
    DICTIONARY = {
        "EN": {
            ...
            "tips": {"dcg": "ISO Country Code", "dac": "Given Names", "dcs": "Surname", "dbb": "Date of Birth", "daq": "License ID", "dag": "Address", "dai": "City", "dak": "Postal Code", "dbd": "Issue Date", "dba": "Expiry Date", "dbc": "Gender: 1=M, 2=F", "dcf": "Audit Number"}
        },
        "FR": {
            ...
            "tips": {"dcg": "Code pays ISO", "dac": "Prénoms", "dcs": "Nom de famille", "dbb": "Date de naissance", "daq": "Identifiant de permis", "dag": "Adresse résidentielle", "dai": "Ville", "dak": "Code postal", "dbd": "Date d'émission", "dba": "Date d'expiration", "dbc": "Sexe : 1=H, 2=F", "dcf": "Numéro d'audit"}
        }
    }
