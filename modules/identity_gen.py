...
def show_identity_gen(lang="EN"):
    ...
    DICTIONARY = {
        "EN": {"title": "Quantum AAMVA Studio", "desc": "Liquid Glass Forensic Data Synthesis Engine", "step1": "Jurisdiction Analysis", "country": "Source Nation", "state": "Regional State", "prov": "Regional Province", "step2": "Identity Matrix Parameters", "step3": "Optical Engine Configuration", "generate": "Initialize Generation Sequence", "success": "Payload matrix successfully compiled.", "raw": "AAMVA Raw String Output", "use": "Standardized payload for external renderers.", "preview": "Digital Twin Preview", "tips": {"dcg": "ISO Country Code", "dac": "Given Names", "dcs": "Surname", "dbb": "Date of Birth", "daq": "License ID", "dag": "Address", "dai": "City", "dak": "Postal Code", "dbd": "Issue Date", "dba": "Expiry Date", "dbc": "Gender: 1=Male, 2=Female", "dcf": "Audit Number"}},
        "FR": {"title": "Studio Quantum AAMVA", "desc": "Moteur de synthèse de données légistes Liquid Glass", "step1": "Analyse de Juridiction", "country": "Nation Source", "state": "État Régional", "prov": "Province Régionale", "step2": "Paramètres de la Matrice d'Identité", "step3": "Configuration du Moteur Optique", "generate": "Initialiser la séquence de génération", "success": "Matrice du payload compilée avec succès.", "raw": "Sortie de chaîne brute AAMVA", "use": "Payload standardisé pour moteurs de rendu externes.", "preview": "Aperçu du jumeau numérique", "tips": {"dcg": "Code pays ISO", "dac": "Prénoms", "dcs": "Nom de famille", "dbb": "Date de naissance", "daq": "Identifiant de licence", "dag": "Adresse résidentielle", "dai": "Ville / Localité", "dak": "Code postal", "dbd": "Date d'émission", "dba": "Date d'expiration", "dbc": "Sexe: 1=Homme, 2=Femme", "dcf": "Numéro d'audit"}}}
